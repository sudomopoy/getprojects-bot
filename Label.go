...
`
	...
	description_new_project_from_user = `🚧 کاربر %v پروژه ای با
	متن : %v
...
❗ درصورت گزارش تخلف، اگهی و فرد متخلف فورا از کانال حذف میشوند`
	...
	به ربات کانال Get Projects خوش اومدی!
	...
	@GetProjectsAdmin`
	description_enter_budget = `💰 بودجه مورد نظر خود را برای پروژه وارد کنید 
مثال :
		100 هزار تومان
		200 تا 500 هزار تومان
		توافقی
و یا میتوانید یکی از دکمه های زیر را انتخاب کنید 👇`
)
